package chapter9.composite.main;

import chapter9.composite.classes.Menu;
import chapter9.composite.classes.MenuItem;
import chapter9.composite.classes.Waitress;
...
public class MenuTestDrive {
  ...
  public static void main(String[] args) {
    ...
    coffeeMenu
        .add(new MenuItem("Biscotti", "Three almond or hazelnut biscotti cookies", true, 0.89));
